                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="text-[#FAF7F0]/50 text-xs italic">
                            Some recipes may be generated by Sous-Chef Linguine AI using traditional authenticity ranking systems.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><Link to="/" className="hover:text-[#CBA55B] transition-colors">Home</Link></li>
                            <li><Link to="/explore" className="hover:text-[#CBA55B] transition-colors">Explore Recipes</Link></li>
                            ...
                            <li><Link to="/contact" className="hover:text-[#CBA55B] transition-colors">Contact</Link></li>
                        </ul>
                    </div>
